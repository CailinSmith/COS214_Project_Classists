...
TEST_CASE("Plant State: Negative Value Edge Cases") {
    SUBCASE("Negative health value - clamped to 0") {
        Rose plant;
        plant.setHeight(0.5);
        plant.setHealth(-0.1); 
        CHECK(plant.getHealth() == 0.0);
    ...
    SUBCASE("Negative height value - clamped to 0") {
        Basil plant;
        plant.setHeight(-0.5);
        plant.setHealth(0.5);
        CHECK(plant.getHeight() == 0.0);
    ...
    SUBCASE("Both negative values - clamped to 0") {
        Tomato plant;
        plant.setHeight(-0.3); 
        plant.setHealth(-0.3); 
        CHECK(plant.getHeight() == 0.0);
    ...
    SUBCASE("Very large negative values - clamped to 0") {
        Lettuce plant;
...
TEST_CASE("Plant State: Values Beyond Maximum Edge Cases") {
    SUBCASE("Health greater than 1.0 - clamped to 1.0") {
        Rose plant;
        plant.setHeight(0.5);
        plant.setHealth(1.5);
        CHECK(plant.getHealth() == 1.0);
        plant.changePlantState();
        CHECK(plant.getState() == "Seedling State");
        plant.changePlantState();
        CHECK(plant.getState() == "Growing"); 
    ...
    SUBCASE("Height greater than 1.0 - clamped to 1.0") {
        Basil plant;
        plant.setHeight(2.0); 
        plant.setHealth(0.5);
        CHECK(plant.getHeight() == 1.0);
        plant.changePlantState();
        CHECK(plant.getState() == "Seedling State");
        plant.changePlantState();
        CHECK(plant.getState() == "Growing"); 
    ...
    SUBCASE("Both values greater than 1.0 - clamped to 1.0") {
        Tomato plant;
        plant.setHeight(1.8); 
        plant.setHealth(1.8); 
        CHECK(plant.getHeight() == 1.0);
...
TEST_CASE("Plant State: Mixed Extreme Values") {
    SUBCASE("Negative health with positive height - health clamped to 0") {
        Rose plant;
        plant.setHeight(0.5);
        plant.setHealth(-0.2); 
        CHECK(plant.getHealth() == 0.0);
    ...
    SUBCASE("Positive health with negative height - height clamped to 0") {
        Basil plant;
        plant.setHeight(-0.3); 
        plant.setHealth(0.7);
        CHECK(plant.getHeight() == 0.0);
    ...
    SUBCASE("Health above 1.0 with negative height - clamped values") {
        Tomato plant;
        plant.setHeight(-0.5); 
        plant.setHealth(1.5); 
        CHECK(plant.getHeight() == 0.0);
